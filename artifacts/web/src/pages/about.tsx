...
import { Store, MapPin, Phone, CalendarHeart } from "lucide-react";
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-8 border-t border-border">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{settings?.address || "Musikot-5, Aapchaur, Gulmi, Nepal"}</p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div className="bg-muted/30 p-8 rounded-2xl border border-border">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              {settings?.deliveryPolicy || t.about.defaultDelivery}
            </p>
          </div>
          <div className="bg-muted/30 p-8 rounded-2xl border border-border">
            <h4 className="font-bold text-lg mb-4">{t.about.termsConditions}</h4>
            <p className="text-muted-foreground text-sm leading-relaxed">
              {settings?.termsConditions || t.about.defaultTerms}
            </p>
          </div>
        </div>
      </div>
