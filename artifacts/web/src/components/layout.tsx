...
import { ShoppingBag, Menu, X, Truck, Info, Store, Languages } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-primary-foreground/80 leading-relaxed max-w-sm">
              {settings?.aboutText || t.nav.servingCommunity}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-primary-foreground/80">
              <li>{settings?.address || "Musikot-5, Aapchaur, Gulmi, Nepal"}</li>
