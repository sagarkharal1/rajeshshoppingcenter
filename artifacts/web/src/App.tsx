...
const [ownerFeedback, setOwnerFeedback] = useState<{ type: "success" | "error"; message: string } | null>(null);
  ...
  const load = async () => {
    ...
    setSettingsForm({
      ...
      rewardPointValue: String(settingsData?.rewardPointValue ?? "1"),
      rewardBonusMultiplier: String(settingsData?.rewardBonusMultiplier ?? "1"),
      rewardBonusLabel: settingsData?.rewardBonusLabel ?? "",
      // <input type="date"> wants YYYY-MM-DD, not a full timestamp.
    ...
    try {
      await api("/admin/settings", {
        ...
        body: JSON.stringify({
          ...
          rewardPointValue: String(settingsForm.rewardPointValue || "1"),
          rewardBonusMultiplier: String(settingsForm.rewardBonusMultiplier || "1"),
          rewardBonusLabel: settingsForm.rewardBonusLabel || null,
